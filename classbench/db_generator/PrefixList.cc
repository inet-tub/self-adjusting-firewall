...
void PrefixList::read_type(int type, FILE *fp) {
  ...
  int matches = 0;
  char comm[7];
  char wc_wc_comm[7]="-wc_wc";
  char wc_lo_comm[7]="-wc_lo";
  char wc_hi_comm[7]="-wc_hi";
  char wc_ar_comm[7]="-wc_ar";
  char wc_em_comm[7]="-wc_em";
  char lo_wc_comm[7]="-lo_wc";
  char lo_lo_comm[7]="-lo_lo";
  char lo_hi_comm[7]="-lo_hi";
  char lo_ar_comm[7]="-lo_ar";
  char lo_em_comm[7]="-lo_em";
  char hi_wc_comm[7]="-hi_wc";
  char hi_lo_comm[7]="-hi_lo";
  char hi_hi_comm[7]="-hi_hi";
  char hi_ar_comm[7]="-hi_ar";
  char hi_em_comm[7]="-hi_em";
  char ar_wc_comm[7]="-ar_wc";
  char ar_lo_comm[7]="-ar_lo";
  char ar_hi_comm[7]="-ar_hi";
  char ar_ar_comm[7]="-ar_ar";
  char ar_em_comm[7]="-ar_em";
  char em_wc_comm[7]="-em_wc";
  char em_lo_comm[7]="-em_lo";
  char em_hi_comm[7]="-em_hi";
  char em_ar_comm[7]="-em_ar";
  char em_em_comm[7]="-em_em";
